...
use claw::prompt_cache::{PromptCache, PromptCacheConfig};
use claw::{
    ...
    OutputContentBlock, ProviderClient, StreamEvent, ToolChoice,
    ToolDefinition,
};
use serde_json::json;
use claw::telemetry::{ClientIdentity, MemoryTelemetrySink, SessionTracer, TelemetryEvent};
        ...
        messages: vec![InputMessage {
            ...
            content: vec![
                ...
                InputContentBlock::ToolResult {
                    ...
                    content: vec![claw::ToolResultContentBlock::Json {
