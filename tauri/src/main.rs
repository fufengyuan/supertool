...
fn main() {
    ...
    // 用法: supertool wg-tunnel --conf <json路径> --socket <fd传递socket路径>
    ...
    if args.iter().any(|a| a == "wg-tunnel") {
        ...
        let socket_path = arg_val("--socket");
        ...
        if let Err(e) = rt.block_on(
            supertool_core::logic::wireguard_tunnel::run_tunnel(&conf_path, &socket_path),
        ) {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::es::es_nodes,
            commands::es::es_cluster_stats,
            commands::es::es_list_indices,
            commands::es::es_index_info,
            commands::es::es_index_mapping,
            commands::es::es_create_index,
            commands::es::es_update_index_settings,
            commands::es::es_delete_index,
            commands::es::es_aliases,
            commands::es::es_update_aliases,
            commands::es::es_reindex,
            commands::es::es_search,
            commands::es::es_get_document,
            commands::es::es_index_document,
            commands::es::es_update_document,
            commands::es::es_delete_document,
            ...
            commands::cicd::get_all_deploy_logs,
            ...
            assistant::commands::test_ai_model_raw,
            ...
            commands::fetch::fetch_page_content_js,
