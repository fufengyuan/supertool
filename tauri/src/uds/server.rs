    ...
    async fn handle_connection(
        ...
        loop {
            ...
            for line in lines {
                ...
                log::info!("[UDS] → {} params={}", req.handler, supertool_core::logic::log_sanitizer::sanitize_params_for_log(req.params.as_ref().unwrap_or(&serde_json::Value::Null), 200));
...
pub fn default_socket_path() -> PathBuf {
    supertool_core::logic::data_dir::uds_socket_path()
}
