    ...
    fn register_default_handlers(&mut self) {
        ...
        router.register("openvpn:get-all", |core, _params| async move {
            let configs = core.db_read(|conn| {
                supertool_core::db::openvpn::get_all(conn).map_err(|e| e.to_string())
            })?;
        ...
        router.register("openvpn:add", |core, params| async move {
            ...
            let id = core.db_write(|conn| {
                supertool_core::db::openvpn::add(conn, &name, &file_path, &content).map_err(|e| e.to_string())
            })?;
        ...
        router.register("openvpn:delete", |core, params| async move {
            ...
            let _ = core.db_write(|conn| {
                supertool_core::db::openvpn::delete(conn, &id).map_err(|e| e.to_string())
            })?;
        ...
        router.register("git:interactive-rebase", |_core, params| async move {
            ...
            let result = Command::new(supertool_core::logic::git::find_git())
        ...
        use supertool_core::db::{CicdConfig, DeployModule};
        ...
        router.register("cicd:get-all-configs", |core, _params| async move {
            let configs = core.db_read(|conn| {
                supertool_core::db::get_all_cicd_configs(conn)
                    .map_err(|e| e.to_string())
            })??;
            Ok(serde_json::to_value(&configs).map_err(|e| e.to_string())?)
        });
        ...
        router.register("cicd:get-groups", |core, _params| async move {
            let groups = core.db_read(|conn| supertool_core::db::get_cicd_groups(conn).map_err(|e| e.to_string()))??;
        ...
        router.register("cicd:get-config", |core, params| async move {
            ...
            let config = core.db_read(|conn| supertool_core::db::get_cicd_config(conn, &project_id).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
        ...
        router.register("cicd:get-config-by-id", |core, params| async move {
            ...
            let config = core.db_read(|conn| supertool_core::db::get_cicd_config_by_config_id(conn, &config_id).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
            Ok(serde_json::to_value(config).map_err(|e| e.to_string())?)
        });
        ...
        router.register("cicd:add-config", |core, params| async move {
            ...
            let result = core.db_write(|conn| supertool_core::db::add_cicd_config(conn, &config).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
            Ok(serde_json::to_value(result).map_err(|e| e.to_string())?)
        });

        router.register("cicd:update-config", |core, params| async move {
            let config: CicdConfig = serde_json::from_value(params.clone()).map_err(|e| e.to_string())?;
            let result = core.db_write(|conn| supertool_core::db::update_cicd_config(conn, &config).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
            Ok(serde_json::to_value(result).map_err(|e| e.to_string())?)
        });

        router.register("cicd:delete-config", |core, params| async move {
            let config_id = params["configId"].as_str().ok_or("Missing configId")?.to_string();
            let _ = core.db_write(|conn| supertool_core::db::delete_cicd_config(conn, &config_id).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
            Ok(json!({"success": true}))
        });
        ...
        router.register("cicd:get-modules", |core, params| async move {
            let config_id = params["configId"].as_str().ok_or("Missing configId")?.to_string();
            let modules = core.db_read(|conn| supertool_core::db::get_deploy_modules(conn, &config_id).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
        ...
        router.register("cicd:add-module", |core, params| async move {
            ...
            let result = core.db_write(|conn| supertool_core::db::add_deploy_module(conn, &module).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
            Ok(serde_json::to_value(result).map_err(|e| e.to_string())?)
        });

        router.register("cicd:update-module", |core, params| async move {
            let module: DeployModule = serde_json::from_value(params.clone()).map_err(|e| e.to_string())?;
            let result = core.db_write(|conn| supertool_core::db::update_deploy_module(conn, &module).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
            Ok(serde_json::to_value(result).map_err(|e| e.to_string())?)
        });
        ...
        router.register("cicd:delete-module", |core, params| async move {
            ...
            let _ = core.db_write(|conn| supertool_core::db::delete_deploy_module(conn, &module_id).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
            Ok(json!({"success": true}))
        });
        ...
        router.register("cicd:get-logs", |core, params| async move {
            ...
            let logs = core.db_read(|conn| supertool_core::db::get_deploy_logs(conn, &project_id, limit).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
        ...
        router.register("cicd:get-step-logs", |core, params| async move {
            ...
            let steps = core.db_read(|conn| supertool_core::db::get_deploy_step_logs(conn, &deploy_log_id).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
        ...
        router.register("cicd:get-deploy-history", |core, params| async move {
            ...
            let history = core.db_read(|conn| supertool_core::db::get_deploy_history(conn, &project_id, limit).map_err(|e| e.to_string())).map_err(|e| e.to_string())?;
        ...
        router.register("cicd:deploy", |core, params| async move {
            ...
            use supertool_core::db::DeployLog;
            ...
            // Load config from DB
            let config: Option<CicdConfig> = core.db_read(|conn| supertool_core::db::get_cicd_config_by_config_id(conn, &config_id)).map_err(|e| e.to_string())?.map_err(|e| e.to_string())?;
            let config = config.ok_or("未找到CI/CD配置")?;

            // Load modules
            let modules: Vec<supertool_core::db::DeployModule> = core.db_read(|conn| supertool_core::db::get_deploy_modules(conn, &config_id)).map_err(|e| e.to_string())?.map_err(|e| e.to_string())?;
            ...
            let _ = core.db_write(|conn| supertool_core::db::touch_cicd_config_deploy(conn, &config_id));
            ...
            let _ = core.db_write(|conn| supertool_core::db::add_deploy_log(conn, &log));
