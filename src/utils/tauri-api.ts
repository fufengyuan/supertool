...
export function getTauriAPI(): TauriAPI {
  ...
  cachedAPI = {
    ...
    dbRedisStreamAdd: async (id: string, dbIndex: number, stream: string, fields: Record<string, unknown>) => tauriCall("db_redis_stream_add", { id, dbIndex, stream, fields }),
    dbRedisStreamMessages: async (id: string, dbIndex: number, stream: string, start: string, end: string, count?: number) => tauriCall("db_redis_stream_messages", { id, dbIndex, stream, start, end, count }),
    dbRedisStreamDel: async (id: string, dbIndex: number, stream: string, entryId: string) => tauriCall("db_redis_stream_del", { id, dbIndex, stream, entryId }),
    ...
    dbRedisStreamClaim: async (id: string, dbIndex: number, stream: string, group: string, consumer: string, entryId: string) => tauriCall("db_redis_stream_claim", { id, dbIndex, stream, group, consumer, entryId }),
    dbRedisStreamAck: async (id: string, dbIndex: number, stream: string, group: string, entryId: string) => tauriCall("db_redis_stream_ack", { id, dbIndex, stream, group, entryId }),
    dbRedisStreamRetry: async (id: string, dbIndex: number, stream: string, group: string, entryId: string) => tauriCall("db_redis_stream_retry", { id, dbIndex, stream, group, entryId }),
    dbRedisStreamTrim: async (id: string, dbIndex: number, stream: string, maxLen: number) => tauriCall("db_redis_stream_trim", { id, dbIndex, stream, maxLen }),
