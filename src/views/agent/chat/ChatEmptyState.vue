<template>
  <div class="flex flex-col items-center justify-center py-16 px-8 text-center flex-1">
    <div class="mb-4 opacity-40">
      <SvgIcon name="bot" size="64" />
    </div>
    <div class="text-lg font-medium text-base-content/70 mb-2">Hermes Chat</div>
...
const suggestions = [
  ...
  { icon: 'clock', label: 'Set a reminder', text: 'Set a reminder to check emails every day at 9 AM' },
  ...
  { icon: 'zap', label: 'Schedule a cron job', text: 'Schedule a cron job to back up my database every night' },
