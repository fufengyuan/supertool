...
.git-section, .git-urls-section {
  padding: 20px; background: var(--color-base-200); border-radius: 12px;
...
.section-subtitle {
  font-size: 12px; font-weight: 400; color: color-mix(in oklab, var(--color-base-content) 60%, transparent);
}
.secondary-label {
  font-size: 12px; color: color-mix(in oklab, var(--color-base-content) 60%, transparent); margin-bottom: 12px;
  font-style: italic;
}
...
.selected-repo-badge {
  ...
  margin-top: 12px; background: color-mix(in oklab, var(--color-primary) 10%, transparent); border: 1px solid var(--color-primary);
  border-radius: 10px; font-size: 13px;
}
.repo-badge-icon { color: var(--color-primary); flex-shrink: 0; }
.repo-badge-name {
  flex: 1; font-weight: 500; color: var(--color-primary);
...
.clear-btn:hover { background: var(--color-error); color: white; }

.branch-section label {
  display: flex; align-items: center; gap: 6px;
  margin-bottom: 8px; font-size: 13px; font-weight: 500; color: var(--color-base-content);
}
.branch-section label svg { color: color-mix(in oklab, var(--color-base-content) 60%, transparent); }
.branch-selector { display: flex; align-items: center; gap: 10px; }
.branch-loading { display: flex; align-items: center; gap: 6px; font-size: 12px; color: color-mix(in oklab, var(--color-base-content) 60%, transparent); }
.spinner {
  width: 14px; height: 14px; border: 2px solid color-mix(in oklab, var(--color-base-content) 10%, transparent);
