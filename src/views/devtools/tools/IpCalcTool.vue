  ...
  <div class="max-w-[700px]">
    ...
    <div class="mb-5">
      ...
      <div class="flex gap-2.5 mb-3 flex-wrap items-center mt-3">
        ...
        <button class="btn btn-ghost btn-sm" @click="copyAll"><SvgIcon name="file" size="14" class="align-text-bottom" /> 复制全部</button>
      ...
      <div v-if="result" class="conversion-section" style="margin-top: 20px">
        ...
        <div class="conversion-grid">
          <div class="conversion-item">
            ...
            <button class="btn btn-ghost btn-sm" @click="doCopy(result.ipDecimal)"><SvgIcon name="file" size="14" class="align-text-bottom" /></button>
          </div>
          <div class="conversion-item">
            <span class="conversion-label">十六进制</span>
            <span class="conversion-value">{{ result.ipHex }}</span>
            <button class="btn btn-ghost btn-sm" @click="doCopy(result.ipHex)"><SvgIcon name="file" size="14" class="align-text-bottom" /></button>
          </div>
          <div class="conversion-item">
            <span class="conversion-label">八进制</span>
            <span class="conversion-value">{{ result.ipOctal }}</span>
            <button class="btn btn-ghost btn-sm" @click="doCopy(result.ipOctal)"><SvgIcon name="file" size="14" class="align-text-bottom" /></button>
          </div>
        </div>
      </div>
    </div>
