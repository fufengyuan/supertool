<template>
  <div class="flex items-center gap-3 p-2 px-3 bg-base-100 border border-base-content/10 rounded-xl flex-wrap">
    ...
    <div class="flex items-baseline gap-1 whitespace-nowrap">
      <span class="text-xs text-base-content/60"><SvgIcon name="star" size="14" class="inline-block align-text-bottom" /> Streak</span>
...
const motivations = [
  ...
  '千里之行，始于足下。加油！✨',
  '高效的一天从完成任务开始！🌟',
  '你的坚持终将美好，继续前进！<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg> ',
  '小步快跑，积少成多，你正在变得更强！🏆',
  '每一次勾选，都是对自己的肯定 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> ',
  '不要等待机会，创造机会！🔥',
  '专注当下，完成眼前的每一件小事 🌈',
  '你已经走了这么远，别停下！🌻',
];
