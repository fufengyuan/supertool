<template>
  <div class="p-6 max-w-2xl mx-auto text-base-content">
    <h2 class="m-0 mb-2 text-xl font-bold"><SvgIcon name="keyboard" size="14" class="inline-block align-text-bottom" /> 快捷键设置</h2>
