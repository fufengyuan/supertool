  ...
  <div class="p-6 space-y-4">
    ...
    <div class="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-4">
      ...
      <div class="bg-base-100 border border-base-content/10 rounded-xl p-5 flex flex-col gap-3">
        ...
        >
          {{ isImporting ? '导入中...' : '<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="inline-block align-text-bottom"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg> 导入备份' }}
        </button>
      </div>
