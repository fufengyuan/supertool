...
.qrcode-tool h3 { font-size: 18px; font-weight: 700; color: var(--main-text); margin: 0 0 20px 0; }
...
.qr-image { border: 1px solid var(--border-color); border-radius: 8px; max-width: 300px; background: white; padding: 8px; }
.loading-box { display: flex; align-items: center; gap: 12px; margin-top: 16px; padding: 12px; color: var(--main-text-secondary); font-size: 13px; }
