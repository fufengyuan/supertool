...
.repo-search-bar {
  ...
  background: var(--color-base-100); border: 1.5px solid color-mix(in oklab, var(--color-base-content) 20%, transparent);
  border-radius: 10px; transition: all 0.15s ease;
}
.repo-search-bar:focus-within {
  border-color: var(--color-primary); box-shadow: 0 0 0 3px color-mix(in oklab, var(--color-primary) 10%, transparent);
}
.search-icon { color: color-mix(in oklab, var(--color-base-content) 60%, transparent); flex-shrink: 0; }
.repo-search-input {
  flex: 1; padding: 10px 0; border: none; background: transparent;
  color: var(--color-base-content); font-size: 14px; outline: none;
}
.repo-search-input::placeholder { color: color-mix(in oklab, var(--color-base-content) 60%, transparent); opacity: 0.7; }
.refresh-btn {
  width: 32px; height: 32px; border: none; border-radius: 8px;
  background: transparent; color: color-mix(in oklab, var(--color-base-content) 60%, transparent); cursor: pointer;
...
.manual-path-row {
  ...
  background: var(--color-base-200); border: 1.5px solid color-mix(in oklab, var(--color-base-content) 10%, transparent);
  border-radius: 10px; transition: all 0.15s ease;
}
.manual-path-row:focus-within {
  border-color: var(--color-primary); box-shadow: 0 0 0 3px color-mix(in oklab, var(--color-primary) 10%, transparent);
}
.path-icon { color: color-mix(in oklab, var(--color-base-content) 60%, transparent); flex-shrink: 0; }
.manual-path-input {
  flex: 1; padding: 10px 0; border: none; background: transparent;
  color: var(--color-base-content); font-size: 13px; outline: none;
  font-family: 'SF Mono', 'Fira Code', monospace;
}
.manual-path-input::placeholder { color: color-mix(in oklab, var(--color-base-content) 60%, transparent); opacity: 0.5; }
.clear-path-btn {
...
.clear-path-btn:hover { background: var(--color-error); color: white; }
.manual-path-valid {
...
.repo-list {
  ...
  background: var(--color-base-100); border: 1px solid color-mix(in oklab, var(--color-base-content) 10%, transparent);
}
.repo-item {
  display: flex; align-items: center; gap: 12px; padding: 12px 14px;
  cursor: pointer; transition: background 0.15s ease; border-bottom: 1px solid color-mix(in oklab, var(--color-base-content) 10%, transparent);
}
.repo-item:last-child { border-bottom: none; }
.repo-item:hover { background: var(--color-base-200); }
.repo-item.selected { background: color-mix(in oklab, var(--color-primary) 10%, transparent); }
.repo-check {
  width: 20px; height: 20px; border-radius: 6px; border: 2px solid color-mix(in oklab, var(--color-base-content) 10%, transparent);
  display: flex; align-items: center; justify-content: center; flex-shrink: 0;
  transition: all 0.15s ease;
}
.repo-item.selected .repo-check { background: var(--color-primary); border-color: var(--color-primary); color: white; }
.repo-info { flex: 1; min-width: 0; }
.repo-name { display: flex; align-items: center; gap: 6px; font-weight: 600; font-size: 13px; color: var(--color-base-content); }
.git-icon-small { color: color-mix(in oklab, var(--color-base-content) 60%, transparent); flex-shrink: 0; }
.repo-path {
  font-size: 12px; color: color-mix(in oklab, var(--color-base-content) 60%, transparent); margin-top: 2px;
  font-family: 'SF Mono', 'Fira Code', monospace;
}
.repo-empty {
  display: flex; flex-direction: column; align-items: center; padding: 28px 20px;
  gap: 8px; color: color-mix(in oklab, var(--color-base-content) 60%, transparent);
}
