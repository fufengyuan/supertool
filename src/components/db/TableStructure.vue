              ...
              <template v-for="(col, idx) in columns" :key="col._uid">
                <tr
                  :class="{
                    ...
                    'ts-row-dragging': dragRowIndex === idx,
                    'ts-drop-before': dropTargetIndex === idx && dropPosition === 'before',
                    'ts-drop-after': dropTargetIndex === idx && dropPosition === 'after',
                  }"
                  :data-row-idx="idx"
...
.ts-drop-before td:first-child {
  position: relative;
}
.ts-drop-before td:first-child::before {
  content: '';
  position: absolute;
...
.ts-drop-after td:first-child::after {
  content: '';
  position: absolute;
