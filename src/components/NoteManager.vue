...
.note-header { display: flex; align-items: center; justify-content: space-between; padding: 14px 20px; background: linear-gradient(135deg, var(--card-bg) 0%, rgba(66, 133, 244, 0.05) 100%); border-radius: 14px; border: 1px solid var(--border-color); flex-shrink: 0; }
...
.note-title { font-size: 20px; font-weight: 700; color: var(--main-text); margin: 0; }
.note-subtitle { font-size: 12px; color: var(--main-text-secondary); margin: 0; opacity: 0.8; }
.note-header-actions { display: flex; align-items: center; gap: 12px; }
.search-wrapper { position: relative; display: flex; align-items: center; color: var(--main-text-secondary); }
.search-wrapper svg { position: absolute; left: 10px; pointer-events: none; }
.search-input { padding: 8px 12px 8px 34px; font-size: 13px; border: 1px solid var(--border-color); border-radius: 20px; background: var(--input-bg); color: var(--main-text); width: 200px; transition: all 0.2s ease; }
.search-input:focus { outline: none; border-color: var(--primary-color); box-shadow: 0 0 0 3px rgba(66, 133, 244, 0.15); width: 260px; }
.btn-new { display: flex; align-items: center; gap: 6px; padding: 8px 16px; font-size: 13px; font-weight: 600; border: none; border-radius: 20px; background: linear-gradient(135deg, var(--primary-color), #34a853); color: white; cursor: pointer; transition: all 0.2s ease; box-shadow: 0 2px 6px rgba(66, 133, 244, 0.25); }
...
.note-sidebar { width: 300px; min-width: 280px; background: var(--card-bg); border-radius: 12px; border: 1px solid var(--border-color); overflow-y: auto; flex-shrink: 0; display: flex; flex-direction: column; }
.group-section { border-bottom: 1px solid var(--border-color); flex-shrink: 0; }
...
.group-header:hover { background: var(--input-bg); }
.group-header-title { font-size: 12px; font-weight: 600; color: var(--main-text-secondary); text-transform: uppercase; letter-spacing: 0.5px; }
.group-chevron { transition: transform 0.2s ease; color: var(--main-text-secondary); }
...
.group-item:hover { background: var(--input-bg); }
...
.group-name { font-size: 13px; color: var(--main-text); flex: 1; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
...
.group-add { display: flex; align-items: center; gap: 6px; padding: 7px 10px; border-radius: 8px; cursor: pointer; color: var(--main-text-secondary); font-size: 12px; transition: all 0.15s ease; margin-top: 2px; }
.group-add:hover { background: var(--input-bg); color: var(--primary-color); }
.sidebar-empty { padding: 40px 20px; text-align: center; color: var(--main-text-secondary); font-size: 14px; }
.note-list { display: flex; flex-direction: column; overflow-y: auto; flex: 1; }
.note-list-item { padding: 12px 14px; cursor: pointer; border-bottom: 1px solid var(--border-color); transition: all 0.15s ease; }
.note-list-item:hover { background: var(--input-bg); }
.note-list-item.active { background: rgba(66, 133, 244, 0.08); border-left: 3px solid var(--primary-color); }
...
.title-text { font-size: 14px; font-weight: 600; color: var(--main-text); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.note-item-delete { width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; border: none; border-radius: 6px; background: transparent; color: var(--main-text-secondary); cursor: pointer; opacity: 0; transition: all 0.15s ease; flex-shrink: 0; }
.note-list-item:hover .note-item-delete { opacity: 1; }
.note-item-delete:hover { background: rgba(210, 15, 57, 0.1); color: var(--danger-color); }
.note-item-preview { font-size: 12px; color: var(--main-text-secondary); opacity: 0.8; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin-bottom: 4px; }
.note-item-meta { display: flex; align-items: center; justify-content: space-between; font-size: 11px; color: var(--main-text-secondary); opacity: 0.6; }
.note-item-group { background: rgba(66, 133, 244, 0.1); color: var(--primary-color); padding: 1px 6px; border-radius: 4px; font-size: 10px; }
.note-editor { flex: 1; min-width: 0; background: var(--card-bg); border-radius: 12px; border: 1px solid var(--border-color); display: flex; flex-direction: column; overflow: hidden; }
.editor-toolbar { display: flex; align-items: center; justify-content: space-between; padding: 10px 16px; border-bottom: 1px solid var(--border-color); flex-shrink: 0; }
.toolbar-left, .toolbar-right { display: flex; align-items: center; gap: 8px; }
.toolbar-btn { padding: 6px 12px; font-size: 12px; font-weight: 500; border: 1px solid var(--border-color); border-radius: 8px; background: transparent; color: var(--main-text-secondary); cursor: pointer; transition: all 0.15s ease; white-space: nowrap; }
.toolbar-btn:hover { background: var(--input-bg); color: var(--main-text); }
.toolbar-btn.active { background: var(--primary-color); color: white; border-color: var(--primary-color); }
.group-selector-wrapper { position: relative; }
.group-selector-btn { display: flex; align-items: center; gap: 4px; }
.group-selector-dropdown { position: absolute; top: 100%; left: 0; margin-top: 4px; background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 10px; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.15); z-index: 100; min-width: 180px; max-height: 240px; overflow-y: auto; padding: 4px; }
.group-option { padding: 8px 12px; font-size: 13px; cursor: pointer; border-radius: 6px; transition: background 0.1s ease; }
.group-option:hover { background: var(--input-bg); }
.group-option.selected { background: rgba(66, 133, 244, 0.12); color: var(--primary-color); font-weight: 500; }
.save-status { font-size: 12px; color: var(--main-text-secondary); }
.editor-title-row { padding: 16px 20px 8px; flex-shrink: 0; }
.editor-title-input { width: 100%; font-size: 22px; font-weight: 700; color: var(--main-text); border: none; background: transparent; padding: 0; }
.editor-title-input:focus { outline: none; }
.editor-title-input::placeholder { color: var(--main-text-secondary); opacity: 0.4; }
.editor-content { flex: 1; min-height: 0; padding: 8px 20px 20px; }
.editor-textarea { width: 100%; height: 100%; min-height: 300px; font-size: 14px; line-height: 1.7; color: var(--main-text); background: transparent; border: none; resize: none; font-family: 'SF Mono', 'Fira Code', 'Consolas', monospace; }
.editor-textarea:focus { outline: none; }
.editor-textarea::placeholder { color: var(--main-text-secondary); opacity: 0.4; }
.editor-preview { flex: 1; min-height: 0; padding: 8px 20px 20px; overflow-y: auto; line-height: 1.7; color: var(--main-text); }
.editor-preview :deep(h1) { font-size: 28px; font-weight: 700; margin: 24px 0 12px; border-bottom: 1px solid var(--border-color); padding-bottom: 8px; }
...
.editor-preview :deep(code) { background: var(--input-bg); padding: 2px 6px; border-radius: 4px; font-family: 'SF Mono', monospace; font-size: 13px; }
.editor-preview :deep(pre) { background: var(--input-bg); padding: 16px; border-radius: 8px; overflow-x: auto; margin: 12px 0; }
.editor-preview :deep(pre code) { background: none; padding: 0; }
.editor-preview :deep(blockquote) { border-left: 3px solid var(--primary-color); padding-left: 16px; margin: 12px 0; color: var(--main-text-secondary); }
.editor-preview :deep(ul), .editor-preview :deep(ol) { padding-left: 24px; margin: 8px 0; }
.editor-preview :deep(li) { margin: 4px 0; }
.editor-preview :deep(a) { color: var(--primary-color); text-decoration: underline; }
...
.editor-preview :deep(th), .editor-preview :deep(td) { border: 1px solid var(--border-color); padding: 8px 12px; text-align: left; }
.editor-preview :deep(th) { background: var(--input-bg); font-weight: 600; }
.editor-preview :deep(.search-highlight) { background: rgba(251, 191, 36, 0.35); color: var(--main-text); border-radius: 2px; padding: 0 2px; }
.editor-preview .preview-empty { color: var(--main-text-secondary); opacity: 0.5; }
.editor-empty { flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; color: var(--main-text-secondary); opacity: 0.5; }
...
.note-dialog { background: var(--card-bg); border-radius: 16px; padding: 24px; max-width: 400px; width: 90%; box-shadow: 0 16px 48px rgba(0, 0, 0, 0.3); }
.note-dialog h3 { font-size: 18px; font-weight: 700; margin: 0 0 12px; color: var(--main-text); }
.note-dialog p { font-size: 14px; color: var(--main-text-secondary); margin: 0 0 20px; }
...
.btn-ghost { background: transparent; color: var(--main-text-secondary); border: 1px solid var(--border-color); }
...
.form-group label { display: block; font-size: 12px; font-weight: 600; color: var(--main-text-secondary); margin-bottom: 6px; }
.form-input { width: 100%; padding: 8px 12px; font-size: 14px; border: 1px solid var(--border-color); border-radius: 8px; background: var(--input-bg); color: var(--main-text); }
.form-input:focus { outline: none; border-color: var(--primary-color); box-shadow: 0 0 0 3px rgba(66, 133, 244, 0.15); }
...
.icon-option:hover { background: var(--input-bg); }
.icon-option.active { border-color: var(--primary-color); background: rgba(66, 133, 244, 0.1); }
.note-list-item :deep(mark) { background: rgba(251, 191, 36, 0.35); color: var(--main-text); border-radius: 2px; padding: 0 2px; }
</style>
